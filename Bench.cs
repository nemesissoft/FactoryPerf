...
| GeneratedDictionary | 12.293 us | 0.0804 us | 0.0752 us |  0.21 | 1.5259 |      - |     - |    9.4 KB |       11 |                 6,724 |                     145 |
    ...
    public class Bench
    {
        ...
        private static readonly GeneratedFactory _generatedFactory = new();
        [Benchmark]
        public int Generated()
        {
            object o = new A001();
            for (int i = 0; i < _classNames.Length; i++)
                o = _generatedFactory.Create(_classNames[i]);

            return o.GetHashCode();
        }

        private static readonly GeneratedDictionaryFactory _generatedDictionaryFactory = GeneratedDictionaryFactory.GetDefault();
        [Benchmark]
        public int GeneratedDictionary()
        {
            object o = new A001();
            for (int i = 0; i < _classNames.Length; i++)
                o = _generatedDictionaryFactory.Create(_classNames[i]);
